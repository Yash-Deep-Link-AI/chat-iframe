window.onload = function () {
  ...
  n.setAttribute("id", "chatbase-bubble-button"),
  ...
  l.setAttribute("id", "chatbase-bubble-window"),
    ...
    (l.innerHTML = `<iframe
src="https://deep-link.ai/#/chat-iframe?botId=${e.getAttribute("botid")}"
width="100%"
height="100%"
frameborder="0"
></iframe>`);
  ...
  let $ = async () => {
    (n.style.backgroundColor = s.color || "black"),
